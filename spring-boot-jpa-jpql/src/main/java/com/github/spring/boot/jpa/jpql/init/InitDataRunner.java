package com.github.spring.boot.jpa.jpql.init;
...
public class InitDataRunner implements CommandLineRunner {
    ...
    private void generateEmployees() {
        for (int i = 0; i < EMPLOYEE_NUM; i++) {
            ...
            EmployeeDO employee = EmployeeDO.builder()
                    .employeeName(FAKER.name().username())
                    .age(FAKER.number().numberBetween(10, 60))
                    .salary(FAKER.number().numberBetween(4000, 6000))
